...
public class DefaultAbacusHImplemetation extends DefaultAbacusABRow implements AbacusMulRow, AbacusDivRow {
	...
	public Map<Integer, Collection<String>> getMulDivTables() {
		...
		Collection<String> mul1 = this.multiplication(27, 99, 35, 99);
		Collection<String> mul2 = this.multiplication(44, 99, 66, 96);
		Collection<String> mul3 = this.division(1234, 7500, 2, 9);
		Collection<String> mul4 = this.division(1790, 7000, 2, 9);
